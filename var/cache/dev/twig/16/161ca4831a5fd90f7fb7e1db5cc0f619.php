...
class __TwigTemplate_7848053bee9d2f471d0224ab5175cb6a extends Template
{
    private $source;
    private $macros = [];
...
{% block panel %}
    ...
    {% endfor %}
{% endblock %}
", "@WebProfiler/Collector/validator.html.twig", "/media/Qi/rkichou/KScouting/vendor/symfony/web-profiler-bundle/Resources/views/Collector/validator.html.twig");
    }
}
