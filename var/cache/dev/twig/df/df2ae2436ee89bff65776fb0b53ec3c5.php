...
class __TwigTemplate_475434d919e6b82466a9d2ba2a591744 extends Template
{
    private $source;
    private $macros = [];
...
{% block panel %}
    ...
    {% endfor %}
{% endblock %}
", "@WebProfiler/Collector/notifier.html.twig", "/media/Qi/rkichou/KScouting/vendor/symfony/web-profiler-bundle/Resources/views/Collector/notifier.html.twig");
    }
}
